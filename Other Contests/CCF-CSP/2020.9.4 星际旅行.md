...
![](C:\Users\HJHGJGHHG\Desktop\My-LeetCode-Solutions\images\2020.9.4.png)
...
* **超球体的任意一条切线（与超球体有且仅有一个公共点的直线）（多维中为超平面）垂直于过切点的半径；对于 $n$ 维空间的一个 $n-1$ 维超平面 $A1x1+A2x2+... +Anxn+B=0$，点 $(p1,p2,...,pn)$ 到其的距离为：**
  ...
  ![](C:\Users\HJHGJGHHG\Desktop\My-LeetCode-Solutions\images\2020.9.4.formula.png)
...
* **X，Y的连线不经过黑洞O：**
    * **如右图：![](C:\Users\HJHGJGHHG\Desktop\My-LeetCode-Solutions\images\2020.9.4.1.png)**
...
* **X与Y的连线不经过黑洞O,但是X和Y的延长线经过黑洞O,此时X和Y的最短曲线距离依旧是X与Y的直线距离。**
    * **如右图：![](C:\Users\HJHGJGHHG\Desktop\My-LeetCode-Solutions\images\2020.9.4.2.png)**
    * **出现这种情况的条件时 $\angle OXY$ 为钝角或直角。即$|OX|^2+|XY|^2\leq|OY|^2$;相似的 $\angle OYX$ 为钝角或直角的情况也一样。**
* **X与Y的连线过黑洞O：**
    * **如右图：![](C:\Users\HJHGJGHHG\Desktop\My-LeetCode-Solutions\images\2020.9.4.3.png)**
